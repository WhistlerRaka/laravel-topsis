            ...
            <div class="card">
                <form role="form" method="POST" action="{{ route('kriteria.update', $data->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        @elseif ((auth()->user()->role == 'user' || auth()->user()->role == 'admin' ) && $dataKriteria)
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Bobot</label>
                                    <input class="form-control" type="number" name="bobot_kriteria" value="{{$dataKriteria->bobot_kriteria}}">
                                </div>
                            </div>
                        </div>
                        @else
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Bobot</label>
                                    <input class="form-control" type="number" name="bobot_kriteria" value="{{$data->bobot}}">
                                </div>
                            </div>
                        </div>
                        @endif
