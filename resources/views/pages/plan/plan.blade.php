...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Paket Internet'])
        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                <div class="d-flex align-items-center">
                    <h6>Plan</h6>
                    <a href="{{route('plan.form')}}" class="btn btn-primary btn-sm ms-auto">Tambah</a>
                </div>
            </div>
                    ...
                    <table id="myTable" class="table align-items-center mb-0 table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Kecepatan
                                </th>
