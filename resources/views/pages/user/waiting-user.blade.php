                    ...
                    <table id="myTable" class="table align-items-center mb-0 table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Username
                                </th>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-end">
                                    <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                        <p class="text-sm font-weight-bold mb-0"><a href="/user/edit/{{ $u->id }}">Detail</a></p>
                                        <p class="text-sm font-weight-bold mb-0 ps-2"><a href="/user/accept/{{ $u->id }}">Accept</a></p>
                                        <p class="text-sm font-weight-bold mb-0 ps-2"><a href="/user/decline/{{ $u->id }}">Decline</a></p>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
