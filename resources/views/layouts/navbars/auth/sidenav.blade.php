        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'plan') == true ? 'active' : '' }}" href="{{ route('plan') }}">
                    ...
                    <span class="nav-link-text ms-1">Paket Internet</span>
                </a>
            </li>
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user' ? 'active' : '' }}" href="{{ route('user.all') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'waiting-user') == true ? 'active' : '' }}" href="{{ route('user.wait') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-folder-17 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Waiting User</span>
                </a>
            </li>
            <li class="nav-item mt-3">
