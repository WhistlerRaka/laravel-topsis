...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/waiting-user', [UserProfileController::class, 'waitingUser'])->name('user.wait');
	Route::get('/user/accept/{id}', [UserProfileController::class, 'acceptUser'])->name('user.acc');
	Route::get('/user/decline/{id}', [UserProfileController::class, 'declineUser'])->name('user.dec');
